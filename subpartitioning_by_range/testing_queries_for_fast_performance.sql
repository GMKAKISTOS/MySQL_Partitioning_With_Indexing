...
--
CREATE TABLE IF NOT EXISTS copy_employees_partrange_year1 AS SELECT * FROM employees_partrange_year1 WHERE 1 = 2;
CREATE TABLE IF NOT EXISTS copy_employees_partrange_year1 AS SELECT * FROM employees_partrange_year1 LIMIT 0;
CREATE TABLE IF NOT EXISTS copy_employees_partrange_year1 LIKE employees_partrange_year1; -- CREATE ALSO THE INDEXES
--
DESCRIBE copy_employees_partrange_year1;
SHOW INDEXES FROM copy_employees_partrange_year1;
ALTER TABLE copy_employees_partrange_year1 ADD PRIMARY KEY(id, hired);
CREATE INDEX hired_indx ON copy_employees_partrange_year1(hired ASC);
SHOW INDEXES FROM copy_employees_partrange_year1;
INSERT INTO copy_employees_partrange_year1 SELECT * FROM employees_partrange_year1 WHERE id BETWEEN 99999900 AND 100000000;
COMMIT;
SELECT * FROM copy_employees_partrange_year1 WHERE id BETWEEN 99999900 AND 100000000;
--
DROP TABLE IF EXISTS copy_employees_partrange_year1;
--
