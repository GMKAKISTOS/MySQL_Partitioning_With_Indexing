...
--
CREATE TABLE copy_employees_partrange_year1 AS SELECT * FROM employees_partrange_year1 WHERE 1 = 2;
CREATE TABLE copy_employees_partrange_year1 AS SELECT * FROM employees_partrange_year1 LIMIT 0;
CREATE TABLE copy_employees_partrange_year1 LIKE employees_partrange_year1; -- CREATE ALSO THE INDEXES
--
